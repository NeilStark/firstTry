...
$(".case-display ul li").click(function(){
	$(this).addClass("active").siblings().removeClass("active");
	var $num=$(this).index();
	$(".case-display .container .bot").eq($num).addClass("showbot").siblings().removeClass("showbot");
})

$(".case-display .container .bot>div").mouseover(function(){
	// alert(1)
	var $num=$(this).index();
